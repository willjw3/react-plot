...
const SimpleFunction = ({xdim, ydim, xdomain, ydomain, xstep, ystep, xdata, dimensions, margin, input_func}) => {
    ...
    const canvas = useRef(null);
     ...
     const addAxes = (svg) => {
        ...
        svg.append("g")
            .call(xAxis)
            .attr("transform", `translate(0, ${(ydim + margin.top + margin.bottom)/2})`);
        ...
        svg.append("g")
            .call(yAxis)
            .attr("transform", `translate(${(margin.left + xdim + margin.right) / 2},0)`)
     ...
     const addFunction = (svg) => {
        ...
        svg.on("mousemove", function() {
            ...
            var beginning = x-margin.left, end = pathLength, target;
            var pos = {};
            while (true) {
